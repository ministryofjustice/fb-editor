class MsListWarningPresenter
  ...
  def link_text
    "#{I18n.t("warnings.publish.#{deployment_environment}.ms_list")} <a class=\"govuk-link\" href=\"https://moj-forms.service.justice.gov.uk/settings/#ms-lists\">#{I18n.t("warnings.publish.#{deployment_environment}.link_text")}</a>"
  end
