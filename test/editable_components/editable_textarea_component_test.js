...
describe('EditableTextAreaComponent', function() {
  const {EditableTextareaFieldComponent} = require('../../app/javascript/src/editable_components');
  ...
  beforeEach(function() {
    var html = `<form id="editableForm">
      ...
      <div id="editableTextAreaComponent">
    ...
    $node = $(document).find('#editableTextAreaComponent');
    $form = $(document).find('#editableForm');

    component = new EditableTextareaFieldComponent($node, {
  ...
  describe('Component', function() {
    it('should be given the correct CSS class', function() {
      expect(component.$node.hasClass('EditableTextareaFieldComponent')).to.be.true;
    })
  })
})
