...
describe("DownForwardUpPath", function() {
  ...
  const CONTAINER_ID = "downforwarduppath-for-testing-component-container";
  const COMPONENT_ID = "downforwarduppath-for-testing-component-connector";
  ...
  describe("Component", function() {
    ...
    it("should have the component class name present", function() {
      ...
      expect($svg.hasClass("DownForwardUpPath")).to.be.true; // Sub class
    });
    ...
    it("should output correct coordinates for the arrow path", function() {
      ...
      expect($path.attr("d")).to.equal("M 1239,58 v10 l 10,-5 z");
    });
