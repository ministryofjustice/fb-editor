...
describe("ForwardDownBackwardUpPath", function() {
  ...
  const CONTAINER_ID = "forwarddownbackwarduppath-for-testing-component-container";
  const COMPONENT_ID = "forwarddownbackwarduppath-for-testing-component-connector";
  ...
  describe("Component", function() {
    ...
    it("should have the component class name present", function() {
      ...
      expect($svg.hasClass("ForwardDownBackwardUpPath")).to.be.true; // Sub class
    });
