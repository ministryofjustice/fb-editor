...
describe("ForwardUpForwardDownPath", function() {
  ...
  const CONTAINER_ID = "forwardupforwarddownpath-for-testing-component-container";
  const COMPONENT_ID = "forwardupforwarddownpath-for-testing-component-connector";
  ...
  describe("Component", function() {
    ...
    it("should have the component class name present", function() {
      ...
      expect($svg.hasClass("ForwardUpForwardDownPath")).to.be.true; // Sub class
    });
    ...
    it("should output correct coordinates for the arrow path", function() {
      ...
      expect($path.attr("d")).to.equal("M 1838,58 v10 l 10,-5 z");
    });
