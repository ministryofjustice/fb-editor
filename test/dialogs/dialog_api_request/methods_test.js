...
describe("DialogApiRequest", function() {
  ...
  describe("Methods", function() {
    ...
    describe("basic", function() {
      const COMPONENT_ID = "dialog-api-request-basic-methods-test-served-response";
    ...
    describe("using generated buttons", function() {
      const COMPONENT_ID = "dialog-api-request-generated-buttons-methods-test-served-response";
    ...
    describe("using template buttons", function() {
      const COMPONENT_ID = "dialog-api-request-template-buttons-methods-test-served-response";
      const CLASSNAME_BUTTON_TEMPLATE = "dialog-api-request-template-buttons-methods-test-button-template";
