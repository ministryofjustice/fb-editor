Rails.application.routes.draw do
  namespace :admin do
    ...
    resources :services, only: [:index, :show, :edit, :update, :create] do
      ...
      get '/approve/:service_id/:deployment_environment', to: 'services#approve', as: :approve
      get '/revoke_approval/:service_id.:deployment_environment', to: 'services#revoke_approval', as: :revoke_approval
