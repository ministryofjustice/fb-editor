Rails.application.config.platform_environments =
  ActiveSupport::HashWithIndifferentAccess.new({
    ...
    common: {
      ...
      user_filestore_url: "http://fb-user-filestore-api-svc-%{platform_environment}-%{deployment_environment}.formbuilder-platform-%{platform_environment}-%{deployment_environment}/",
      container_port: 3000
    }
  })
