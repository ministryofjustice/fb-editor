  ...
  context 'when creating list' do
    context 'when successful' do
      ...
      before do
        ...
        .with(
          body: "{\"displayName\":\"Branching Fixture - test - 27dc30c9-f7b8-4dec-973a-bd153f6797df\",\"columns\":[{\"name\":\"debcefbcbdf\",\"displayName\":\"Submission ID\",\"text\":{}},{\"name\":\"bdfaeebcbe\",\"displayName\":\"Reference Number\",\"text\":{}},{\"name\":\"bfebbbeafabacdef\",\"displayName\":\"Full name from name\",\"text\":{\"allowMultipleLines\":true,\"appendChangesToExistingText\":false,\"linesForEditing\":6,\"maxLength\":10000,\"textType\":\"plain\"}},{\"name\":\"deaffeabbcdf\",\"displayName\":\"Do you like Star Wars? from do-you-like-star-wars\",\"text\":{\"allowMultipleLines\":true,\"appendChangesToExistingText\":false,\"linesForEditing\":6,\"maxLength\":10000,\"textType\":\"plain\"}},{\"name\":\"adcbfeffadfdf\",\"displayName\":\"What was the name of the band playing in Jabba's palace? from star-wars-knowledge\",\"text\":{\"allowMultipleLines\":true,\"appendChangesToExistingText\":false,\"linesForEditing\":6,\"maxLength\":10000,\"textType\":\"plain\"}},{\"name\":\"fffcaaefdfffb\",\"displayName\":\"What is The Mandalorian's real name? from star-wars-knowledge\",\"text\":{\"allowMultipleLines\":true,\"appendChangesToExistingText\":false,\"linesForEditing\":6,\"maxLength\":10000,\"textType\":\"plain\"}},{\"name\":\"fcbdbbfeb\",\"displayName\":\"What is your favourite fruit? from favourite-fruit\",\"text\":{\"allowMultipleLines\":true,\"appendChangesToExistingText\":false,\"linesForEditing\":6,\"maxLength\":10000,\"textType\":\"plain\"}},{\"name\":\"fbaebbacfbcf\",\"displayName\":\"Do you like apple juice? from apple-juice\",\"text\":{\"allowMultipleLines\":true,\"appendChangesToExistingText\":false,\"linesForEditing\":6,\"maxLength\":10000,\"textType\":\"plain\"}},{\"name\":\"cceafbaeaafd\",\"displayName\":\"Do you like orange juice? from orange-juice\",\"text\":{\"allowMultipleLines\":true,\"appendChangesToExistingText\":false,\"linesForEditing\":6,\"maxLength\":10000,\"textType\":\"plain\"}},{\"name\":\"dfafceedaf\",\"displayName\":\"What is your favourite band? from favourite-band\",\"text\":{\"allowMultipleLines\":true,\"appendChangesToExistingText\":false,\"linesForEditing\":6,\"maxLength\":10000,\"textType\":\"plain\"}},{\"name\":\"fdfdadedafbfde\",\"displayName\":\"Which app do you use to listen music? from music-app\",\"text\":{\"allowMultipleLines\":true,\"appendChangesToExistingText\":false,\"linesForEditing\":6,\"maxLength\":10000,\"textType\":\"plain\"}},{\"name\":\"ddebbfcfcbcdf\",\"displayName\":\"What is the best form builder? from best-formbuilder\",\"text\":{\"allowMultipleLines\":true,\"appendChangesToExistingText\":false,\"linesForEditing\":6,\"maxLength\":10000,\"textType\":\"plain\"}},{\"name\":\"baaafbafaecbbaff\",\"displayName\":\"Which Formbuilder is the best? from which-formbuilder\",\"text\":{\"allowMultipleLines\":true,\"appendChangesToExistingText\":false,\"linesForEditing\":6,\"maxLength\":10000,\"textType\":\"plain\"}},{\"name\":\"eafdebfefacf\",\"displayName\":\"What would you like on your burger? from burgers\",\"text\":{\"allowMultipleLines\":true,\"appendChangesToExistingText\":false,\"linesForEditing\":6,\"maxLength\":10000,\"textType\":\"plain\"}},{\"name\":\"ddcecdbadb\",\"displayName\":\"What is the best marvel series? from marvel-series\",\"text\":{\"allowMultipleLines\":true,\"appendChangesToExistingText\":false,\"linesForEditing\":6,\"maxLength\":10000,\"textType\":\"plain\"}},{\"name\":\"cceadacfdc\",\"displayName\":\"Select all Arnold Schwarzenegger quotes from best-arnold-quote\",\"text\":{\"allowMultipleLines\":true,\"appendChangesToExistingText\":false,\"linesForEditing\":6,\"maxLength\":10000,\"textType\":\"plain\"}}],\"list\":{\"template\":null}}",
          headers: {
            'Accept' => '*/*',
            'Accept-Encoding' => 'gzip;q=1.0,deflate;q=0.6,identity;q=0.3',
            'Authorization' => 'Bearer valid_token',
