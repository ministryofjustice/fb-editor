...
feature 'First publish for approval' do
  ...
  def then_I_accept_the_declarations
    check 'declarations-checkboxes-declaration-1-field', visible: false
    check 'declarations-checkboxes-declaration-2-field', visible: false
    check 'declarations-checkboxes-declaration-3-field', visible: false
    check 'declarations-checkboxes-declaration-4-field', visible: false
    check 'declarations-checkboxes-declaration-5-field', visible: false
    check 'declarations-checkboxes-declaration-6-field', visible: false
  end
